...
const WeatherIcon = ({ weatherCode, moment }) => {
    ...
    const weatherCode2Type = (weatherCode) => {
        // 轉換為Array => Object.entries(weatherTypes)
        const [type] = Object.entries(weatherTypes).find(([type, Codes]) => 
    ...
    /**
     * useMemo() => 效能優化-避免不必要的重複運算
     * dependency array 中的變數沒有改變, useMemo中的函式就不會執行
